...
# Plot PMF
par(las = 1)
plot(y,prob,type="h",xlab="k",ylab="P(X=k)",ylim=c(0,0.30), yaxs="i", main  = "Fictional pmf", bty = "n")
@
...
par(las = 1, xpd=NA)
plot.stepfun(cdf.plot,xlab="x",ylab="F(x)",verticals=FALSE,do.points=TRUE,pch=16, yaxs="i", main = "Corresponding cdf", bty = "n", lwd = 3, col = "blue")
