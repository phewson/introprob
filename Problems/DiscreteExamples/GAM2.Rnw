...
and you have $X$ as the number of people in your sample with GAM, $n$ is the size of your sample and $p$ is the probability that a person has GAM, i.e. $0.1$
