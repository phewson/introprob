...
%% packages
\usepackage{a4wide,color,verbatim,Sweave,url,xargs,longtable}
\usepackage{tikz}
%% new environments
...
%% headings
\markboth{\textnormal{\bf \large 	MATH1505 Homework: \myID}}%
{\textnormal{\bf \large MATH1505 Problems: \myID}}
...
\thispagestyle{empty}
{\sf
\textbf{\LARGE{Plymouth University, School of Computing and Mathematics}}

\textbf{\large{MATH1505 Homework \myDate \hfill Homework ID \myID}}
...
The in-class test will consist of one or two of these questions templates.   You should develop the habit of setting out your workings carefully - although the in-class test will just ask for numeric / short text or multiple choice answers.   You should make sure you understand what you are doing.
